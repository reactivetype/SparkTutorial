...
if __name__ == "__main__":
  ...
  #
  #                       Replace each 'None' by the correct RDD operations
  #
  # ------------------------------------------------------------------------------------------------
